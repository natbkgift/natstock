    ...
    <div class="card-body">
        <form method="POST" action="/admin/products/update">
            ...
            <div class="form-group">
                ...
                <textarea name="note" class="form-control"><?= e($product->note) ?></textarea>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="date" name="expire_date" class="form-control" value="<?= e($product->expire_date) ?>">
                </div>
                <div class="form-group col-md-4">
                    <label>จุดสั่งซื้อซ้ำ</label>
                    <input type="number" name="reorder_point" class="form-control" value="<?= e($product->reorder_point) ?>">
                </div>
                <div class="form-group col-md-4">
